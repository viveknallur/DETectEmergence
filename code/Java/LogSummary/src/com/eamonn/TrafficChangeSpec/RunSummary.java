...
public class RunSummary {
	...
	private HashMap <Integer,Double> neighSize;
	                 //Time          //Rel #   //CarNames     
	private HashMap <Integer,HashMap<Integer,Set<String>>> specificRels;
	...
	public RunSummary(){
		...
		specificRels = new HashMap<Integer,HashMap<Integer,Set<String>>>();
	}
	...
	public void addToSetSpecificRels(int i, HashMap<Integer,Set<String>> s){
		specificRels.put(i,s);
	}
	...
	public HashMap <Integer,HashMap<Integer,Set<String>>> getSpecificRels() {
		return specificRels;
	}


	public void setSpecificRels(HashMap <Integer,HashMap<Integer,Set<String>>> specificRels) {
		this.specificRels = specificRels;
	}
}
