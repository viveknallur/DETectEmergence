...
public class RunSummary {
	 ...
	 */
	private HashMap <Integer,Double> objectMeasure;
	...
	public RunSummary(){
		objectMeasure = new HashMap<Integer, Double>();
	...
	public void addToObjectMeasure(int i, Double s) {
	 ...
	 * @return
	 */
	public HashMap<Integer, Double> getObjectMeasure() {
		return objectMeasure;
	}

	public void setObjectMeasure(HashMap<Integer, Double> objectMeasure) {
